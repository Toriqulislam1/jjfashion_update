                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{old('f_name')}}" type="text" name="f_name"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                               required>
                                        <div class="invalid-feedback">{{\App\CPU\translate('Please enter your full name')}}!</div>
                                    </div>
                                </div>
                                <!--<div class="col-sm-6">-->
                                <!--    <div class="form-group">-->
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number"  value="{{old('phone')}}" id="myNumber" name="phone"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                               required>
...
@push('script')
    ...
    <script>
function myFunction() {
  document.getElementById("myNumber").defaultValue = "88";
}
</script>
@endpush
