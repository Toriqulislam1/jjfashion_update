...
<!-- template-style-->
	...
	<a href="https://wa.me/+8801756-555100" class="float" target="_blank">
                            ...
                            <div class="cz-preview">
                                @if($product->images!=null)
                                    @foreach (json_decode($product->images) as $key => $photo)
                                        <div
                                            class="cz-preview-item d-flex align-items-center justify-content-center imageSelectingPreview{{$key}} {{$key==0?'active':''}}" style=" border:1px solid;"
                                            id="image{{$key}}">
                                            <img class="cz-image-zoom img-responsive" style="width:100%;max-height:350px;"
                            ...
                            <!-- Quantity + Add to cart -->
                                ...
                                <div class="d-flex justify-content-start mt-2 mb-3">
                                    <button
                                        ...
                                        onclick="buy_now()"
                                        type="button"
                                        style="width:37%; height: 45px; background: #FF6666 !important; color: #ffffff;">
                                    ...
                                    <div class="px-4 pt-lg-3 pb-3 mb-3 mr-0 mr-md-2" style="background: #ffffff;border-radius:10px;min-height: 817px;">
                                        <div class="tab-content px-lg-3">
                                            ...
                                            <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                                <img src="{{asset('public/assets/front-end/img/size.jpeg')}}" style="height: 400px; width: 400px"/>
