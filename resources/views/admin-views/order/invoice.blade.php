        ...
        <table style="width: 100%">
            <tr>
                <th class="content-position-y bg-primary"
                    style="padding-top:10px; padding-bottom:10px;text-align: left; width: 100%">
                    ...
                    <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i
                        ...
                        : {{$company_email}}</div>
                         <div class="text-white" style="padding-top:5px; padding-bottom:2px;"><i
                            class="fa fa-envelope text-white" aria-hidden="true"></i> Address
                        : POLICE PLAZA CONCORD SHOPPING MALL 4TH FLOOR, LIFT-3, SHOP NO. 406, GULSHAN.</div>
                </th>
    ...
    <table class="content-position">
        <tr>
            <th style="text-align: left">
                <img height="40" width="130" src="{{asset("storage/app/public/company/$company_web_logo")}}"
                     alt="">
            </th>
            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <div class="h4 montserrat-normal-600">
                        ...
                        <p style=" margin-top: 6px; margin-bottom:0px;">{{$order->customer['phone'] !=null? $order->customer['phone']: $order->shippingAddress['phone']}}</p>
    ...
    <div class=" content-height content-position-y" style="">
        <table class="customers bs-0">
            ...
            <tr class="for-th">
                ...
                <th class="for-th bg-primary">{{\App\CPU\translate('image')}}</th>
        ...
        <tr>
            ...
            <th style="text-align: right;width:70%;">
                <table style="width: 96%;margin-left:41%; display: inline " class="text-right sm-padding strong bs-0">
                    ...
                    <tr>
                        <th class="gry-color text-left "><b style="font-size:15px">{{\App\CPU\translate('sub_total')}}</b></th>
                        <td style="font-size:15px">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($sub_total))}}</td>
                    </tr>
                    <tr>
                        <th class="gry-color text-left text-uppercase"><b style="font-size:15px">{{\App\CPU\translate('tax')}}</b></th>
                        <td style="font-size:15px">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($total_tax))}}</td>
                    </tr>
                    @if ($order->order_type=='default_type')
                        <tr>
                            <th class="gry-color text-left"><b style="font-size:15px">{{\App\CPU\translate('shipping')}}</b></th>
                            <td style="font-size:15px">{{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($shipping))}}</td>
                        </tr>
                    @endif
                    <tr>
                        <th class="gry-color text-left"><b style="font-size:15px">{{\App\CPU\translate('coupon_discount')}}</b></th>
                        <td style="font-size:15px">
                            - {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($order->discount_amount))}} </td>
                    </tr>
                    @if ($order->order_type=='POS')
                        <tr>
                            <th class="gry-color text-left"><b style="font-size:15px">{{\App\CPU\translate('extra_discount')}}</b></th>
                            <td style="font-size:15px">
                                - {{\App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($ext_discount))}} </td>
                        </tr>
                    @endif
                    <tr class="border-bottom">
                        <th class="gry-color text-left"><b style="font-size:15px">{{\App\CPU\translate('discount_on_product')}}</b></th>
                        <td style="font-size:15px">
                    ...
                    <tr class="bg-primary" style="background-color: #2D7BFF">
                        <th class="text-left"><b class="text-white" style="font-size:15px">{{\App\CPU\translate('total')}}</b></th>
                        <td class="text-white" style="font-size:15px">
