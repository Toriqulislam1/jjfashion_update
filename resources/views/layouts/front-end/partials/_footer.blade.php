...
<div class="d-flex justify-content-center text-center {{Session::get('direction') === "rtl" ? 'text-md-right' : 'text-md-left'}} mt-3"
        ...
        <div class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}" >
            <a href="{{route('terms')}}">
                <div style="text-align: center;">
                                        <i class="fa fa-file-text-o" style="font-size:28px;color:red"></i>
                ...
                <div style="text-align: center;">
                        ...
                        <p>
                            {{\App\CPU\translate('terms_&_conditions')}}
                        </p>
    ...
    <div class="col-md-3 d-flex justify-content-center">
        <div >
            <a href="#">
                <div style="text-align: center;">
                     <i class="fa fa-reply" aria-hidden="true" style="font-size:28px;color:red"></i>
                                ...
                                <div class="text-nowrap mb-4" style="position:relative;">
                                    <form action="{{ route('subscription') }}" method="post">
                                        ...
                                        <button class="subscribe-button" type="submit"
                                            style="{{Session::get('direction') === "rtl" ? 'float:right;left:0px;border-radius:5px 0px 0px 5px;' : 'float:right;right:0px; border-radius:0px 5px 5px 0px;'}};font-size: .94rem; background: red;">
